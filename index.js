/**
 * Telegram‑бот «CalorieBot» (Node.js / JavaScript, ESM)
 * =====================================================
 *
 * Использует бесплатное API — Open Food Facts (https://world.openfoodfacts.org/).
 *
 * ⚙️  Настройка
 * ----------------------------------------------------------------
 * 1. Создайте файл **.env**:
 ...
 *      node calorie_bot.js   # Node 18+ (с глобальным fetch)
 *
 * 📦 Что делает
 * ----------------------------------------------------------------
 * • При отсутствии продукта во встроенном словаре бот обращается к
 *   OpenFoodFacts API, получает калории (per 100 g) и кэширует их локально.
 */
